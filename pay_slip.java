    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            if(rs.next()){
                ...
                {
                     t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                     t1.append("\n       Tax   :  0% of gross "+ (gross));   
                }
                else if(gross>=250000 && gross<=500000)
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   5% of gross "+ (gross*5/100));  
                }
                else if(gross>500000 && gross<=750000)
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   10% of gross "+ (gross*10/100));  
                }
                else if(gross>750000 && gross<=1000000)
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   15% of gross "+ (gross*15/100));  
                }
                else if(gross>1000000 && gross<=1250000)
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   20% of gross "+ (gross*20/100));  
                }
                else if(gross>1250000 && gross<=1500000)
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   25% of gross "+ (gross*25/100));  
                }
                else
                {
                    t1.append("\n       GROSS SALARY :"+gross+"    \n       NET SALARY : "+net);
                    t1.append("\n       Tax   :   30% of gross "+ (gross*30/100));
                }
