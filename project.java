...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("pay/icon/payroll.jpg"));
        ...
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icons/New.png")));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/schedreport.png")));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/newinvoice.png")));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icons/EditOpen.png")));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/empreport.png")));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/EXPENSE.PNG")));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/payments.png")));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/empreport.png")));
        ...
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icons/New.png")));
        ...
        u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/calc.png")));
        ...
        util.add(u2);
        JMenuItem u3 = new JMenuItem("Chrome");
        u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/chromes.png")));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("pay/icon/exit.PNG")));
